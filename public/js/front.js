...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'App',
  components: {
    Header: _components_Header__WEBPACK_IMPORTED_MODULE_0__["default"] //    Footer
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios // pagina con valore di default 1, gestisco la navigazione sui buttons
      .get("http://127.0.0.1:8000/api/posts?page=".concat(page)).then(function (res) {
    ...
    sendForm: function sendForm() {
      ...
      axios.post('http://127.0.0.1:8000/api/utentes', {
        ...
        if (res.data.errors) {
          ...
          _this.name = '', _this.email = '', _this.message = '', _this.errors = {}, _this.success = true;
        }
      })["catch"](function (err) {
        console.log(err);
      });
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "card" },
    [
      _c("img", { attrs: { src: _vm.post.cover, alt: "post.title" } }),
      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "content" }, [
      ...
      _c("p", [
        _vm._v(
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam hic atque sunt quidem cumque reiciendis dolorem voluptate illo exercitationem dolore sequi aperiam nihil eum omnis aspernatur, facilis cupiditate sit. Voluptates!"
        )
      ])
    ])
  }
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "container" }, [_c("h2", [_vm._v("Post")])])
  }
]
render._withStripped = true
...
/* harmony import */ var _pages_ContactUs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/ContactUs */ "./resources/js/pages/ContactUs.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/contact-us',
    name: 'contact-us',
    component: _pages_ContactUs__WEBPACK_IMPORTED_MODULE_4__["default"]
  }, {
    path: '/blog/:slug',
    name: 'single-post',
...
module.exports = __webpack_require__(/*! C:\Users\Giada\Desktop\classe34\boolpress_2\resources\js\front.js */"./resources/js/front.js");
